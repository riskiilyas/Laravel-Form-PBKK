            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            ...
                            <p>
                                Here are all users on our app<br />
                                Join our community and get as much credit as you can!
                            </p>
                        </div>
                    </div>
                    <!-- /.col end-->
                ...
                <div style="text-align: center">
                    <form action="/register">
                        <button type="submit" class="btn btn-success btn-lg" href="/register">
